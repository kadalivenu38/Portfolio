export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <img src="./assets/profile-img.png" alt="" className="rounded-full w-32 mt-10" />
            <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I'm Kadali Venu
                <img src="./assets/hand-icon.png" alt="" className="w-6 mb-1" />
            </h3>
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Full-Stack Web Developer</h1>
            <p className="max-w-2xl mx-auto font-Ovo">Passionate Full-Stack Developer focused on building modern, scalable web applications.
                Turning ideas into impactful digital solutions through continuous learning and innovation.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/Venu_Full-Stack-Web-Developer_Resume.pdf" download
